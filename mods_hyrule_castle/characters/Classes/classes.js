...
exports.default = lesClass;
var fs = require("fs");
function lesClass(nameClass) {
    var i = 0;
    var ifFind = false;
    var classs = fs.readFileSync('/home/oui/mods_hyrule_castle/characters/Classes/classes.json', 'utf-8');
    var parseClasss = JSON.parse(classs);
    var Class = {
        id: 0,
        name: '',
        strengths: [0],
