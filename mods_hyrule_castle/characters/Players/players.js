...
exports.default = lesplayers;
var fs = require("fs");
function lesplayers(namePlayer) {
    var i = 0;
    var ifFind = false;
    var players = fs.readFileSync('/home/oui/mods_hyrule_castle/characters/Players/players.json', 'utf-8');
    var parsePlayers = JSON.parse(players);
    var Hero = {
        id: 0,
        name: '',
        hp: 0,
